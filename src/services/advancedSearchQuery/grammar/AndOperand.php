...
{
    public function __construct(private SimpleValueWrapper | DateField | Field | NotExpression | OrExpression $operand, private ?self $tail = null)
    {
    }
    ...
    public function getOperand(): SimpleValueWrapper | DateField | Field | NotExpression | OrExpression
    {
        return $this->operand;
    }

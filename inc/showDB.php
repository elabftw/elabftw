...
if (count($results_arr) === 0 && $search_type != 'none') {
    ...
    <div class='align_right'>
        ...
        <a href='make_zip.php?id=<?php echo (new \Elabftw\Elabftw\Tools)->buildStringFromArray($results_arr); ?>&type=items'>
            <img src='img/zip.png' title='make a zip archive' alt='zip' />
        </a>

        <a href='make_csv.php?id=<?php echo (new \Elabftw\Elabftw\Tools)->buildStringFromArray($results_arr); ?>&type=items'>

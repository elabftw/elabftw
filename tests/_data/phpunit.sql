...
INSERT INTO `users` (`userid`, `salt`, `password`, `team`, `usergroup`, `firstname`, `lastname`, `email`, `phone`, `cellphone`, `skype`, `website`, `register_date`, `token`, `limit_nb`, `sc_create`, `sc_edit`, `sc_submit`, `sc_todo`, `chem_editor`, `validated`, `lang`) VALUES

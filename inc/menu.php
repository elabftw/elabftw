...
if (isset($_SESSION['auth']) && $_SESSION['is_admin'] === '1') {
    ...
    if (check_executable('git')) {
        ...
        } else { //curl extension not loaded
                echo "<a class='errors' href='https://github.com/NicolasCARPi/elabftw/wiki/Troubleshooting#manual-intervention-needed'>You need to install curl extension for php. Click this message.</a>";
        }

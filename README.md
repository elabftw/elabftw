...
* [elabftw-gdpr](https://github.com/harrytyp/elabftw-gdpr): Compiles a report of the personal data stored about a user for EU GDPR Art. 15 subject access requests

...
* [eLabFTW Extensions WebApp](https://elabftw-extensions.tools.coscine.dev/): A Streamlit web app for tools and extensions that employ the eLabFTW API, currently featuring an `*.ics* upload to eLabFTW's scheduler. Feel free to [contribute more extensions](https://gitlab.git.nrw/eln-rwth/elabftw-extensions). 

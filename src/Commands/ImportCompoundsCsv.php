...
final class ImportCompoundsCsv extends Command
{
    ...
    protected function configure(): void
    {
        $this->setDescription('Import compounds from a CSV file')
            ...
            ->addOption('match-with', 'm', InputOption::VALUE_REQUIRED, 'Match existing resources with the value of the provided custom field. For example: "--match-with cas" will link Compounds to Resources having an custom field "cas" with the same value as the Compound\'s CAS number.')

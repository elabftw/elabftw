...
const t = {
  translation: {
    ...
    "created-at": "Créé à",
    "created-on": "Créé le",
    "create-one-experiments": "Créer une expérience sans utiliser de modèle",
    "create-one-items": "Créer une ressource sans utiliser de modèle",
    "create-one-experiments_templates": "Créer un modèle d'expérience",
    "create-one-items_types": "Créer un modèle de ressource",
    "create-resource-from-template": "Créer une ressource à partir d'un modèle",
    "create-experiment-from-template": "Créer une expérience depuis ce modèle",
    ...
    "email-sent-to-x": "E-mail envoyé à {{num, number}} utilisateurs.",
    "email": "Email",
    ...
    "entity-patch-multi-warning": "{{count, number}} entrées ont été modifiées, mais {{failed, number}} entrées n’ont pas pu être modifiées. Elles ont été marquées en rouge.",
    ...
    "error-parsing-metadata": "Une erreur s'est produite lors de l'analyse des métadonnées (champs personnalisés). Le message d'erreur complet a été enregistré dans la console du navigateur.",
    "excellent-accessibility": "Excellente accessibilité",
    "existing-ror-associations": "Associations ROR existantes",
    "experiment": "Expérience",
    "experiment-template": "Modèle d'expérience",
    "export": "Export",
    "export-success": "Exportation réussie.",
    "filename": "Nom du fichier",
    "firstname": "Prénom",
    "format": "Format",
    "good-accessibility": "Bonne accessibilité",
    "id": "Id",
    ...
    "item": "Ressource",
    "item-type": "Modèle de ressources",
    ...
    "info-deleted-entries": "Êtes-vous sûr de vouloir supprimer {{count, number}} {{entity, string}} ?",
    "info-deleted-entry": "Êtes-vous sûr de vouloir supprimer cette {{entry, string}} ?",
    "insufficent-contrast": "Contraste insuffisant",
    "invalid-info": "La syntaxe ou les informations fournies ne sont pas valides.",
    "is-locked": "Est verrouillé",
    "large-text-only": "Texte volumineux uniquement",
    ...
    "no-rors": "Aucun ROR n'est encore associé.",
    "not-set": "Non défini",
    ...
    "other": "Autre",
    "owner": "Propriétaire",
    "ownership-transfer": "Votre entrée a été transférée avec succès à l'utilisateur sélectionné.",
    ...
    "ror-description": "Ces ROR s'appliquent à l'ensemble de l'instance et sont héritées par toutes les équipes.",
    "ror-description-team": "Ces ROR ne s'appliquent qu'à l'équipe actuelle.",
    "ror-description-user": "Ces ROR s'appliquent uniquement à votre compte.",
    "ror-input-label": "Ajouter l'identifiant du Registre des Organismes de Recherche (ROR)",
    "ror-input-title": "Saisissez un identifiant ROR valide de 9 caractères, par exemple 04t0gwh46 ou https://ror.org/04t0gwh46",
    "save": "Enregistrer",
    ...
    "session-expiring": "Votre session expirera bientôt en raison d’une inactivité.",
    "session-expiring-title": "Expiration de la session eLabFTW",
    ...
    "title": "Titre",
    "today": "Aujourd’hui",
    "toggle-pin": "Épingler/Désépingler",
    ...
    "view-upgrade-guide": "Consulter le guide de mise à niveau",
  },
};
export default t;

describe('Team', () => {
  ...
  it('Show team page', () => {
    ...
    cy.get('h2.section-title').should('contain.text', 'Members');
    ...
    cy.get('h2.section-title').should('contain.text', 'Send an email to users');
    cy.get('#loading-spinner').should('not.exist');
    ...
    cy.get('h2.section-title').should('contain.text', 'Procurement requests');
    cy.get('#loading-spinner').should('not.exist');

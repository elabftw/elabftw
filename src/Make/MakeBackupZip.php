...
{
    public function __construct(protected ZipStream $Zip, AbstractConcreteEntity $entity, private string $period, bool $includeChangelog)
    {
        parent::__construct($entity, $includeChangelog);
    }

...
final class i18n4Js
{
    ...
    private function getTerms(): array
    {
        return array(
            ...
            'export' => _('Export'),
            'export-success' => _('Exported successfully.'),
            ...
            'lastname' => _('Lastname'),
            'license-error' => _('You must grant this license to complete your submission.'),
            ...
            // more generic error for imports/exports
            'submission-error' => _('Error during submission. Please check the console for more information.'),

...
$floor1 = $StorageUnits->create('1er étage', $hospital);
$floor2 = $StorageUnits->create('2ème étage', $hospital);
$floor3 = $StorageUnits->create('296ème étage', $hospital);
$radioroom = $StorageUnits->create('Pièce radioactivité', $floor3);
...
$tiroir1 = $StorageUnits->create('Étagère A', $placard2);
$tiroir2 = $StorageUnits->create('Étagère B', $placard2);
$tiroir3 = $StorageUnits->create('Étagère B', $placard1);

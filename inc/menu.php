...
if (isset($_SESSION['auth']) && $_SESSION['is_admin'] === '1') {
    ...
    if (check_executable('git')) {
        ...
        // let's use the IP adress to gain in DNS resolution time
        //curl_setopt($ch, CURLOPT_URL, "https://192.30.252.139/repos/NicolasCARPi/elabftw/git/refs/heads/master");

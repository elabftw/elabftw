...
final class CompoundParams extends ContentParams
{
    public function getContent(): string | int | float
    {
        return match ($this->target) {
            ...
            'unii',
            'wikidata',
            'wikipedia' => trim($this->content),
            'ec_number' => $this->isValidEcOrExplode($this->content),
            'cas_number' => $this->isValidCasOrExplode($this->content),
            'is_corrosive',
            'is_explosive',
            'is_flammable',
            ...
            'is_hazardous2health',
            'is_oxidising',
            'is_toxic' => Filter::toBinary($this->content),

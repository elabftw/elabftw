...
const t = {
  translation: {
    ...
    "lastname": "Cognome",
    "license-error": "You must grant this license to complete your submission.",
    ...
    "submission-error": "Error during submission. Please check the console for more information.",

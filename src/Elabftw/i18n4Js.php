...
final class i18n4Js
{
    ...
    private function getTerms(): array
    {
        return array(
            ...
            'auto-size-columns' => _('Auto-size columns'),
            ...
            'create-resource-from-template' => _('Create resource from template'),
            'create-experiment-from-template' => _('Create experiment from template'),
            ...
            'format' => _('Format'),
            'good-accessibility' => _('Good accessibility'),
            'id' => _('Id'),
            ...
            'fit-columns-to-table' => _('Fit columns to table'),
            'import' => _('Import'),
            ...
            'insufficent-contrast' => _('Insufficient contrast'),
            'invalid-info' => _('Invalid syntax or information provided.'),
            'is-locked' => _('Is locked'),
            'large-text-only' => _('Large text only'),
            ...
            'restore-default-layout' => _('Restore default layout'),

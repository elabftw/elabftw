    ...
    protected function getRows(): array
    {
        ...
        foreach ($this->entityArr as $entity) {
            $rows[] = array(
                ...
                'title' => htmlspecialchars_decode((string) $entity->entityData['title'], ENT_QUOTES),
                'userid' => $entity->entityData['userid'],
                'fullname' => $entity->entityData['fullname'],
                'body' => html_entity_decode(strip_tags(htmlspecialchars_decode((string) $entity->entityData['body'], ENT_QUOTES))),
                'category' => (string) $entity->entityData['category'],
                'category_title' => htmlspecialchars_decode((string) $entity->entityData['category_title'], ENT_QUOTES),
                'category_color' => (string) $entity->entityData['category_color'],
                'status' => (string) $entity->entityData['status'],
                'status_title' => htmlspecialchars_decode((string) $entity->entityData['status_title'], ENT_QUOTES),

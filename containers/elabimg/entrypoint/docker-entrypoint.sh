...
phpConf() {
    ...
    open_basedir="/.dockerenv:/elabftw/:/var/lib/elabftw/:/tmp/:/run/elabftw/tmp:/run/elabftw/cache:/usr/bin/unzip:/etc/ssl/cert.pem:/run/s6-rc/servicedirs/s6rc-oneshot-runner"
    # DEV MODE
    if ($dev_mode); then

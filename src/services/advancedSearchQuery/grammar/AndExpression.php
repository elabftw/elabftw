...
{
    public function __construct(private SimpleValueWrapper|DateField|Field|NotExpression|OrExpression $expression, private ?AndOperand $tail = null)
    {
    }
    ...
    public function getExpression(): SimpleValueWrapper|DateField|Field|NotExpression|OrExpression
    {

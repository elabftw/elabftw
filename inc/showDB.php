...
if (count($results_arr) === 0 && $search_type != 'none') {
    ...
    <div class='align_right'>
        ...
        <a href='make.php?what=zip&id=<?php echo (new \Elabftw\Elabftw\Tools)->buildStringFromArray($results_arr); ?>&type=items'>
            <img src='img/zip.png' title='make a zip archive' alt='zip' />
        </a>

        <a href='make.php?what=csv&id=<?php echo (new \Elabftw\Elabftw\Tools)->buildStringFromArray($results_arr); ?>&type=items'>

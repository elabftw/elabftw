...
final class i18n4Js
{
    ...
    private function getTerms(): array
    {
        return array(
            ...
            // we can escape link's html as link = code generated by us and not by user
            'event-bound-experiment' => _('Event is bound to an experiment: {{- link }}.'),
            'event-bound-item' => _('Event is bound to an item: {{- link }}.'),
            'export' => _('Export'),

...
$I->click('html.fontawesome-i2svg-active.fontawesome-i2svg-complete body div#container.container-fluid div.real-container section#main_section.box div.dropdown a.clickable.align_right');

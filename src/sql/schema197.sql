...
ALTER TABLE experiments
  ADD COLUMN canread_base  TINYINT UNSIGNED NOT NULL DEFAULT 20,
...
ALTER TABLE items
  ADD COLUMN canread_base  TINYINT UNSIGNED NOT NULL DEFAULT 20,
  ADD COLUMN canbook_base  TINYINT UNSIGNED NOT NULL DEFAULT 20,
  ADD COLUMN canwrite_base TINYINT UNSIGNED NOT NULL DEFAULT 20;
ALTER TABLE items_types
  ...
  ADD COLUMN canwrite_base TINYINT UNSIGNED NOT NULL DEFAULT 20;
ALTER TABLE users
  ADD COLUMN default_read_base  TINYINT UNSIGNED NOT NULL DEFAULT 20,

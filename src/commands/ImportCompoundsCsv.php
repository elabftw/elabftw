...
final class ImportCompoundsCsv extends Command
{
    ...
    protected function configure(): void
    {
        $this->setDescription('Import compounds from a CSV file')
            ->setHelp('Column names that will match: cas, chebi_id, chembl_id, dea_number, drugbank_id, dsstox_id, ec_number, hmdb_id, inchi, inchikey, iupacname, is_antibiotic_precursor, is_cmr, is_controlled, is_corrosive, is_drug_precursor, is_explosive, is_explosive_precursor, is_flammable, is_gas_under_pressure, is_hazardous2env, is_hazardous2health, is_nano, is_oxidising, is_radioactive, is_serious_health_hazard, is_toxic, is_ed2health, is_ed2env, is_pbt, is_vpvb, is_pmt, is_vpvm, kegg_id, metabolomics_wb_id, molecularformula, molecularweight, name, nci_code, nikkaji_number, pharmgkb_id, pharos_ligand_id, pubchemcid, rxcui, smiles, unii, wikidata, wikipedia. A column named "comment" will be added to the main text of the associated resource if a resource is associated with it.')

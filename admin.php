...
try {
    ...
    <hr>
        <form method='post' action='app/controllers/AdminController.php' autocomplete='off'>
            ...
            <span class='smalltip-gray'><?= _('An admin account will always be able to delete experiments.') ?></span>
            </p>
            <p>
            ...
            <div class='timestampInputs'>
                ...
                <span class='smalltip-gray'><?= _('This should be the URL used for <a href="https://tools.ietf.org/html/rfc3161">RFC 3161</a>-compliant timestamping requests.') ?></span>
                </p>
                <p>
                ...
                <span class='smalltip-gray'><?= _('This should be the login associated with your timestamping service provider') ?></span>
                </p>
                <p>
                ...
                <span class='smalltip-gray'><?= _('Your timestamping service provider password') ?></span>
                </p>
            </div>
        ...
        foreach ($usersArr as $user) {
            ?>
                ...
                ?>
                        ...
                        <li><label class='block' for='usersUpdatePassword'><?= _('Reset user password') ." <span class='smallgray'>" . $Auth::MIN_PASSWORD_LENGTH . " " . _('characters minimum') ?></span></label>
                        <input class="clean-form" id='usersUpdatePassword' type='password' pattern='.{0}|.{<?= $Auth::MIN_PASSWORD_LENGTH ?>,}' value='' name='password' /></li>

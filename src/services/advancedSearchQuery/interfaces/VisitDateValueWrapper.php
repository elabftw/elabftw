...
interface VisitDateValueWrapper
{
    public function VisitDateValueWrapper(DateValueWrapper $dateValueWrapper, VisitorParameters $parameters): WhereCollector|int;
}

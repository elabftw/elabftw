...
class DatabaseView
{
    ...
    public function __construct($id, $team)
    {
        ...
        $this->database = new Database($this->id, $team);
    ...
    public function view()
    {
        ...
        $html .= $this->buildView();
        $html .= $this->uploads->buildUploads($this->id, 'view', 'items');
    ...
    public function edit()
    {
        ...
        $html = $this->buildEdit();
        $html .= $this->uploads->buildUploadForm($this->id, 'items');
        $html .= $this->uploads->buildUploads($this->id, 'edit', 'items');
    ...
    private function buildView()
    {
        ...
        // TAGS
        $html .= " " . show_tags($this->id, 'items_tags');
    ...
    private function buildEdit()
    {
        ...
        $html .= "<img class='align_right' src='img/big-trash.png' title='delete' alt='delete' onClick=\"deleteThis('" . $this->id . "','item', 'database.php')\" />";

        // tags
        $html .= displayTags('items', $this->id);

        // main form
        $html .= "<form method='post' action='app/editDB-exec.php' enctype='multipart/form-data'>";

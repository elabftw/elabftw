...
define('EMAIL_NEW_USER_BODY_2', 'Thanks for using eLabFTW :)
...
define('ADMIN_STATUS_ADD_NEW', 'Add here a new status');
...
define('LOGIN_ALREADY', 'You are already logged in!');
...
define('LOGIN_FOOTER', "Don't have an account ? <a href='register.php'>Register</a> now!<br>
    Lost your password? <a href='#' class='trigger'>Reset</a> it !");
...
define('REGISTER_EMAIL_SUBJECT', '[eLabFTW] New user registered');
...
define('REGISTER_LOGOUT', "Please <a style='text-decoration:underline' href='logout.php'>logout</a> before you register another account.");
...
// TIMESTAMP.PHP
define('TIMESTAMP_CONFIG_ERROR', "The timestamping feature is not configured. Please read the <a href='https://github.com/NicolasCARPi/elabftw/wiki/finalizing#setting-up-timestamping'>wiki</a>.");
...
define('UCP_CURRPASS', 'Enter your current password to change personnal infos');
...
define('SHOW_XP_NO_TPL', "<strong>You do not have any templates yet.</strong> Go to <a href='ucp.php?tab=3'>your control panel</a> to make one !");
define('SHOW_XP_NO_EXP', "<strong>Welcome to eLabFTW.</strong>Click the <img src='img/add.png' alt='Create experiment' /><a href='create_item.php?type=exp'>Create experiment</a> button to get started.");

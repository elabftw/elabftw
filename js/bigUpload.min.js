function bigUpload(){this.settings={inputField:"bigUploadFile",formId:"bigUploadForm",progressBarField:"bigUploadProgressBarFilled",timeRemainingField:"bigUploadTimeRemaining",responseField:"bigUploadResponse",submitButton:"bigUploadSubmit",progressBarColor:"#29AEB9",progressBarColorError:"#c4f9ff",scriptPath:"inc/bigUpload.php",scriptPathParams:"",chunkSize:1E6,maxFileSize:214748364800};this.uploadData={uploadStarted:!1,file:!1,numberOfChunks:0,aborted:!1,paused:!1,pauseChunk:0,key:0,timeStart:0,
...
c.readAsBinaryString(e)}};this.sendFileData=function(){var a=decodeURI((/id=(.+?)(&|$)/.exec(location.search)||[,null])[1]),b=document.URL.match(/experiments/);"experiments"!=b&&(b="items");var d="key="+this.uploadData.key+"&realname="+this.uploadData.file.name+"&type="+b+"&item_id="+a;xhr=new XMLHttpRequest;xhr.open("POST",parent.settings.scriptPath+"?action=finish",!0);xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");xhr.onreadystatechange=function(){if(4==xhr.readyState){var c=
JSON.parse(xhr.response);0!==c.errorStatus||200!=xhr.status?parent.printResponse(c.errorText,!0):(parent.resetKey(),parent.$(parent.settings.submitButton).value="Start Upload",parent.printResponse("File uploaded successfully.",!1),bigtype="items"==b?"database":"experiments",$("#filesdiv").load(bigtype+".php?mode=edit&id="+a+" #filesdiv",function(){$(".thumbnail p.editable").editable("app/editinplace.php",{tooltip:"Click to edit",indicator:"Saving...",id:"id",name:"filecomment",submit:"Save",cancel:"Cancel",
"style\u00c2":"display:inline"})}),parent.success(c))}};xhr.send(d)};this.abortFileUpload=function(){this.uploadData.aborted=!0;var a="key="+this.uploadData.key;xhr=new XMLHttpRequest;xhr.open("POST",this.settings.scriptPath+"?action=abort",!0);xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");xhr.onreadystatechange=function(){if(4==xhr.readyState){var a=JSON.parse(xhr.response);0!==a.errorStatus||200!=xhr.status?parent.printResponse(a.errorText,!0):parent.printResponse("File upload was cancelled.",
!0)}};xhr.send(a)};this.pauseUpload=function(){this.uploadData.paused=!0;this.printResponse("",!1);this.$(this.settings.submitButton).value="Resume"};this.resumeUpload=function(){this.uploadData.paused=!1;this.$(this.settings.submitButton).value="Pause";this.sendFile(this.uploadData.pauseChunk)};this.progressUpdate=function(a){var b=Math.ceil(a/this.uploadData.numberOfChunks*100);this.$(this.settings.progressBarField).style.width=b+"%";0===a%5&&(this.uploadData.totalTime+=(new Date).getTime()-this.uploadData.timeStart,
console.log(this.uploadData.totalTime),b=Math.ceil(this.uploadData.totalTime/a*(this.uploadData.numberOfChunks-a)/100),console.log(Math.ceil(this.uploadData.totalTime/a*this.settings.chunkSize/1024)+"kb/s"),this.$(this.settings.timeRemainingField).textContent=b+" seconds remaining")};this.printResponse=function(a,b){this.$(this.settings.responseField).textContent=a;this.$(this.settings.timeRemainingField).textContent="";!0===b&&(this.$(this.settings.progressBarField).style.backgroundColor=this.settings.progressBarColorError)}}
;

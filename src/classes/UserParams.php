...
final class UserParams extends ContentParams implements ContentParamsInterface
{
    public function getContent(): string
    {
        return match ($this->target) {
            ...
            'is_sysadmin', 'uploads_layout', 'pdf_sig', 'use_markdown', 'use_isodate', 'inc_files_pdf', 'append_pdfs', 'disable_shortcuts', 'validated', 'notif_comment_created', 'notif_comment_created_email', 'notif_step_deadline', 'notif_step_deadline_email', 'notif_user_created', 'notif_user_created_email', 'notif_user_need_validation', 'notif_user_need_validation_email', 'notif_event_deleted', 'notif_event_deleted_email' => (string) Filter::toBinary($this->content),

...
final class EntityParams extends ContentParams implements ContentParamsInterface
{
    ...
    public function getContent(): mixed
    {
        return match ($this->target) {
            ...
            'date', 'metadata', 'proc_price_notax', 'proc_price_tax', 'book_price_notax', 'book_price_tax' => $this->getUnfilteredContent(),
            'proc_currency', 'book_price_currency' => Currency::from($this->asInt())->value,
